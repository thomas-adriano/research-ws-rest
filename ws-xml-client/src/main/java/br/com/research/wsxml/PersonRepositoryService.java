 ...
 * 
 */
@WebServiceClient(name = "PersonRepositoryService", targetNamespace = "http://wsxml.research.com.br/", wsdlLocation = "http://localhost:8080/ws-xml-tomcat-1.0/services/PersonRepository?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONREPOSITORYSERVICE_QNAME = new QName("http://wsxml.research.com.br/", "PersonRepositoryService");
    ...
    public PersonRepository getPersonRepositoryPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsxml.research.com.br/", "PersonRepositoryPort"), PersonRepository.class, features);
    }
